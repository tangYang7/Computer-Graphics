...
function main(){
    ...
    frontViewMatrix.setLookAt(0, 0, 15, 0, 15, -100, 0, 1, 0);
    backViewMatrix.setLookAt(0, 0, -10, 0, 0, 100, 0, 1, 0);

    pespProjMatrix.setPerspective(30, canvas.width/canvas.height, 1, 100);
    orthoProjMatrix.setOrtho(-2, 2, -2, 2, -100, 100);
//    pesypProjMatrix2.setPerspective(30, canvas.width*2/canvas.height, 1, 100);
...
function draw(x, y){
    ...
    drawOneViewport(gl, 200, 0, canvas.width/2, canvas.height/2,
                    0.6, 0.6, 0.6,
                    orthoProjMatrix, backViewMatrix, modelMatrix1, modelMatrix2 );
}
