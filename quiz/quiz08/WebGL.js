...
var FSHADER_SOURCE = `
    ...
    void main(){
        ...
        if( (texColor0[0])*(texColor0[0]) + (texColor0[1])*(texColor0[1]) + (texColor0[2]- 1.0)*(texColor0[2]- 1.0) < 0.36 ){
          texColor = texColor1;
        }
        else if( (texColor0[0]- 1.0)*(texColor0[0]- 1.0) + (texColor0[1])*(texColor0[1]) + (texColor0[2])*(texColor0[2]) < 0.09 &&
                 (texColor2[0]- 1.0)*(texColor2[0]- 1.0) + (texColor2[1]- 1.0)*(texColor2[1]- 1.0) + (texColor2[2]- 1.0)*(texColor2[2]- 1.0) < 0.49 ){
...
function draw(){
    ...
    modelMatrix.scale(objScale*0.3, objScale*0.3, objScale*0.3);
